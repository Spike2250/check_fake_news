...
"}")
        ...
        self.show_dt = QPushButton(self.top_frame)
        self.show_dt.setObjectName(u"show_dt")
        self.show_dt.setEnabled(False)
        self.show_dt.setStyleSheet(u"QPushButton {\n"
"background-color: rgba(50, 98, 115, 190);\n"
"font-size: 12pt;\n"
"color: White;\n"
"border: None;\n"
...
"}")
        ...
        self.gridLayout.addWidget(self.show_dt, 7, 1, 1, 1)
...
"border: none;")
        ...
        self.gridLayout.addWidget(self.model_status, 0, 0, 8, 1)
...
"border: none;")
        ...
        self.gridLayout.addWidget(self.process, 0, 2, 8, 1)
...
"background-color: transparent;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.show_dt.setText(QCoreApplication.translate("MainWindow", u"Show Discrimination Threshold", None))
